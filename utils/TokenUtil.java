package com.liasplf.ncumall.utils;
...
public class TokenUtil {
    ...
    // 加密密文，私钥
    public static final String JWT_SECRET = "wxf";
...
//				.setHeader(header) // 设置头部信息
    ...
    public static String getToken(User user) {
        ...
        try {
            ...
            jwt = TokenUtil.createJWT("Jack", "李四", subject);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return jwt;
    ...
    public static String getIDByToken(String jwt) throws Exception {
        Claims c = TokenUtil.parseJWT(jwt);
        if (c == null) return null;
        JSONObject jsonObject = JSON.parseObject(c.getSubject());
    ...
    public static Integer getIDByRequest(HttpServletRequest httpServletRequest) throws Exception {
        ...
        Integer userID = null;
        String temp = TokenUtil.getIDByToken(token);
        if (temp == null) return null;
        userID = Integer.parseInt(temp);
        return userID;
    }

    public static String getManageToken(Manage manage) {
        String subject = JSON.toJSONString(manage);
        String jwt = "";
        try {
            // "Jack"是jwt签发者，"李四"是jwt接收者
            jwt = TokenUtil.createJWT("Jack", "李四", subject);
    ...
    public static boolean validate(String jwtStr) throws Exception {
        Claims claims = null;
